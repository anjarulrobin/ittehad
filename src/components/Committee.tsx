...
const members = [
    ...
    { id: "2", name: "মাওলানা ফয়জুল্লাহ", phone: "01723456791", passingYear: 2010 },
    { id: "3", name: "মাওলানা ফয়জুল্লাহ", phone: "01723456791", passingYear: 2010 }
]
const committees = [{ id: '1', name: 'উপদেস্টা পর্ষদ' }, { id: '2', name: 'শুরা কমিটি' }, { id: '3', name: 'সাব-কমিটি' }];
        ...
        <div className="mt-3 mx-6">{
            committees.map((commite) => (
                <div className="m-2">
                    ...
                    >
                        <div className="w-fit font-ittehad-hind-shiliguri font-ittehad-subtitle text-xl"> {commite.name}</div>
                        {(committee === commite.id) ? <UpperIcon /> : <LowerIcon />}
                    </div>
                            ...
                            members.map((member) => (
                                <div className="m-2 flex justify-between">
                                    <div>
                                        ...
                                        <p className="m-1">সন: {member.passingYear}</p>
                                    </div>
                                    <div className="flex items-center">
                                        <a href={`sms:${member.phone}`} className="mx-3">
