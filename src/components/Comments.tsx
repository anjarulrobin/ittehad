                    ...
                    comments?.map((comment, index) => (
                        ...
                        >
                            <div className="flex justify-between">
                                <div className="flex">
                                    <div>
                                        <div className="flex">
                                            ...
                                            <div className="flex">
                                                <p className="bg-[#E1FFF8] text-[#20BB96] text-[8px] mx-0.5 h-fit"> {comment.sender.userType === 'teacher' ? 'ফুজালা' : 'আবনা'}</p>
                                                <p className="bg-[#E1FFF8] text-[#20BB96] text-[8px] mx-0.5 h-fit"> {comment.sender.passingYear}</p>
                                            </div>
                                        </div>
                                        <p className="text-xs"> {comment.sender.name}</p>
                                ...
                                <p className="text-[10px] "> {getBanglaDate(new Date(comment.createdAt))}</p>
                            </div>
                        </div>
                    ))
                }
